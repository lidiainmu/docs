...
Some headless CMSes provide additional resources to help you integrate with Astro. Like Storyblok, who provide an Astro [integration](/en/guides/integrations-guide/) that helps fetch the content specifically for an Astro site, or Sanity, which provides an official [clean Sanity + Astro template](https://www.sanity.io/templates/astro-sanity-clean). Others provide a JavaScript SDK, a library that you install and use to fetch your remote content.
